...
s.platform     = :ios, "8.0"
s.source       = { :git => "https://github.com/awesomedu/GTCommonKit.git", :tag => "0.5.24" }
...
#GTProgressHud
s.subspec "GTProgressHud" do |ph|
ph.source_files = "Pod/Classes/Tools/GTProgressHud/*.{h,m}"
end
...
view.source_files = "Pod/Classes/Category/UIView/*.{h,m}"
end
