...
s.platform     = :ios, "8.0"
s.source       = { :git => "https://github.com/awesomedu/GTCommonKit.git", :tag => "0.4.4" }
...
cty.source_files = "Pod/Classes/Category/NSString/*.{h,m}"
cty.source_files = "Pod/Classes/Category/NSDictionary/*.{h,m}"
end
s.subspec "Tools" do |tts|
tts.source_files = "Pod/Classes/Tools/SlidingKit/*.{h,m}"
end
